    ...
    <div>
        <div class="lkp-nav-hamburger">
            <input
                ...
                v-model="menuOpen"
                v-on:keydown.esc="menuOpen = false"
            />
            <label
                ...
                role="button"
                tabindex="0"
                v-on:keydown.enter.prevent="toggleMenu"
                v-on:keydown.space.prevent="toggleMenu"
            >
        ...
        <div class="lkp-menu-wrapper">
            ...
            <div
                v-if="topMenuItems && topMenuItems.length"
                class="lkp-top-menu"
            >
                <a
...
export default defineComponent({
    ...
    props: {
        items: {
            type: Array as () => NavMenuItem[],
            required: true,
        },
        topMenuItems: {
            type: Array as () => TopMenuItem[],
            default: () => [],
        },
    },
    setup() {
