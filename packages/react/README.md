...
const App: React.FC = () => {
    ...
    const footerConfig: FooterConfig = {
        description:
            "The Liver Knowledge Portal provides access to liver disease data...",
        columns: [
            {
                title: "About",
                links: [
...
This package includes [Storybook](https://storybook.js.org/) (v10) for interactive component development and visual testing.
...
Stories are in `src/stories/` and cover all components (`LkpHeader`, `LkpNavMenu`, `LkpLayout`, `LkpFooter`) with multiple variants.
